...
def main():
    ...
    # Results
    print(f'Inferencia Nevada:\n\n'
          f'File: PoroTomo_iDAS025_160321073717.sgy\n'
    ...
    # Results
    print(f'File: PoroTomo_iDAS025_160321073747.sgy\n'
          f'Total traces: {total}\n'
          f'Predicted seismic: {tr_seismic}, predicted noise: {tr_noise}\n'
          f'Predicted fil_seismic: {fil_seismic}, predicted fil_noise: {fil_noise}\n')
    ...
    # Results
    print(f'File: PoroTomo_iDAS16043_160321073721.sgy\n'
          f'Total traces: {total}\n'
          f'Predicted seismic: {tr_seismic}, predicted noise: {tr_noise}\n'
          f'Predicted fil_seismic: {fil_seismic}, predicted fil_noise: {fil_noise}\n')
    ...
    # Results
    print(f'File: PoroTomo_iDAS16043_160321073751.sgy\n'
          f'Total traces: {total}\n'
          f'Predicted seismic: {tr_seismic}, predicted noise: {tr_noise}\n'
          f'Predicted fil_seismic: {fil_seismic}, predicted fil_noise: {fil_noise}\n')
