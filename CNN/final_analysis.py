...
def main():
    ...
    # Dumb model line
    plt.hlines(0.5, 0, 1, 'b', '--')
    plt.title(f'PR curves best models CNN STEAD y DAS ')
    plt.xlabel('Recall')
    plt.ylabel('Precision')
    plt.xlim(-0.02, 1.02)
    plt.ylim(0.48, 1.02)
    plt.grid(True)
    plt.legend(loc='best', frameon=False)
    plt.savefig(f'../Analysis/Final/Best/Comp_PR_cnn.png')
    plt.xlim(0.97, 1.01)
    plt.ylim(0.6, 1.01)
    plt.legend(loc='best', frameon=False)
    plt.savefig(f'../Analysis/Final/Best/Comp_PR_cnn_zoom.png')
    ...
    # Dumb model line
    plt.plot([0, 1], [0, 1], 'b--')
    plt.title(f'ROC curves best models CNN STEAD y DAS')
    plt.xlabel('False Positive Rate')
    plt.ylabel('Recall')
    plt.xlim(-0.02, 1.02)
    plt.ylim(-0.02, 1.02)
    plt.grid(True)
    plt.legend(loc='best', frameon=False)
    plt.savefig(f'../Analysis/Final/Best/Comp_ROC_cnn.png')
    plt.xlim(-0.02, 0.8)
    plt.ylim(0.97, 1.005)
    plt.legend(loc='best', frameon=False)
    plt.savefig(f'../Analysis/Final/Best/Comp_ROC_cnn_zoom.png')
    ...
    plt.title(f'Fscore vs thresholds curves best models CNN STEAD y DAS')
    plt.xlabel('Threshold')
    plt.ylabel('F-score')
    plt.xlim(-0.02, 1.02)
    plt.ylim(-0.02, 1.02)
