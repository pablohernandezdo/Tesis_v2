...
python ../train_validation.py \
              ...
              --classifier Cnn1_3k_10 --model_name Cnn1_3k_10_1e4_256_40_X > ../Analysis/logs/train/step4/Cnn1_3k_10_1e4_256_40_X.txt

echo "Evaluating model Cnn1_3k_10_1e4_256"
python ../eval.py --test_path $tst \
              --model_folder step4 \
              --classifier Cnn1_3k_10 --model_name Cnn1_3k_10_1e4_256_40_X > ../Analysis/logs/eval/step4/Cnn1_3k_10_1e4_256_40_X.txt
#
## Learning rate 5e-5
#
