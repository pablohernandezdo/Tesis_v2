...
python ../eval.py --train_path $trn --test_path $tst \
              ...
              --model_name C_1epch_1e6_16 > ../logs/CNN/eval/C_1epch_1e6_16.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier C \
              --model_name C_1epch_1e6_32 > ../logs/CNN/eval/C_1epch_1e6_32.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier C \
              --model_name C_1epch_1e6_64 > ../logs/CNN/eval/C_1epch_1e6_64.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              ...
              --model_name CBN_1epch_1e6_16 > ../logs/CNN/eval/CBN_1epch_1e6_16.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier CBN \
              --model_name CBN_1epch_1e6_32 > ../logs/CNN/eval/CBN_1epch_1e6_32.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier CBN \
              --model_name CBN_1epch_1e6_64 > ../logs/CNN/eval/CBN_1epch_1e6_64.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              ...
              --model_name CBN_v2_1epch_1e6_16 > ../logs/CNN/eval/CBN_v2_1epch_1e6_16.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier CBN_v2 \
              --model_name CBN_v2_1epch_1e6_32 > ../logs/CNN/eval/CBN_v2_1epch_1e6_32.txt
...
python ../eval.py --train_path $trn --test_path $tst \
              --thresh 0.5 --classifier CBN_v2 \
              --model_name CBN_v2_1epch_1e6_64 > ../logs/CNN/eval/CBN_v2_1epch_1e6_64.txt