...
def main():
    ...
    francia_tp = list(map(int, francia_tp))
    nevada_tp = list(map(int, nevada_tp))
    belgica_tp = list(map(int, belgica_tp))
    reykjanes_tp = list(map(int, reykjanes_tp))

    california_tn = list(map(int, california_tn))
    tides_tn = list(map(int, tides_tn))
    utah_tn = list(map(int, utah_tn))
    shaker_tn = list(map(int, shaker_tn))
    signals_tn = list(map(int, signals_tn))
