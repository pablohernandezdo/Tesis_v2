...
python ../train_validation.py --train_path $trn --val_path $val \
              --classifier C --model_name LSTM_1e4_16_validation \
              --n_epochs 1 --batch_size 16 --lr 1e-4  > ../logs/LSTM/train/LSTM_1e4_16_validation.txt

# Evaluate CBN on train and test datasets
echo "Evaluating CBN model on $trn and $tst datasets"
python ../eval.py --train_path $trn  \
              --classifier C --model_name LSTM_1epch_1e4_16_validation > ../logs/LSTM/eval/LSTM_1epch_1e4_16_validation.txt
